...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tutor_chamado_pendente__ = __webpack_require__(609);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__home_home__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_utils_utils__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_status_bar__ = __webpack_require__(68);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TutorChamadoPendentePage = /** @class */ (function () {
    ...
    TutorChamadoPendentePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["m" /* Component */])({
            selector: 'page-tutor-chamado-pendente',template:/*ion-inline-start:"C:\Users\M4Sistemas\Downloads\ppa-ionic-ios-master\ppa-ionic-ios-master\src\pages\tutor-chamado-pendente\tutor-chamado-pendente.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Chamados pendentes</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <div class="content-list">\n    <ion-list no-lines>\n\n      <ion-item-sliding *ngFor="let ch of chamadosPendente" class="sliding">\n\n        <ion-item (click)="requisitionSetTheme(ch)" [ngClass]="{\'chamado-atendimento\':ch.statuses_id==2}">\n          <ion-avatar item-start>\n            <img [src]="ch.image">\n          </ion-avatar>\n          <p>Ticket: {{ch.id_call}}</p>\n          <p>{{ch.name}} </p>\n          <p>Cabine: {{ch.board}}</p>\n          <p>{{ch.matter}}</p>\n\n          <ion-icon small color="iconColor" name="code-working" item-end></ion-icon>\n        </ion-item>\n\n        <ion-item-options side="right">\n          <button ion-button (click)="cancelarChamado(ch)" color="danger">\n            <ion-icon name="trash"></ion-icon>\n          </button>\n        </ion-item-options>\n\n      </ion-item-sliding>\n    </ion-list>\n  </div>\n</ion-content>'/*ion-inline-end:"C:\Users\M4Sistemas\Downloads\ppa-ionic-ios-master\ppa-ionic-ios-master\src\pages\tutor-chamado-pendente\tutor-chamado-pendente.html"*/,
        }),
